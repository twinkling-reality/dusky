...
/**
 * The bar. No rule under it, because the page below is a drawing and a line
 * across the top of a drawing is a line in the drawing.
 */
export function SiteHeader({ repo, children }: { repo?: string; children?: ReactNode }) {
  return (
    <header className={styles.bar}>
      ...
      <nav className={styles.nav}>
        ...
        {repo && (
          ...
          >
            <span className={styles.sr}>Source on GitHub</span>
